...
if (isset($_POST['submit'])) {
    ...
    if (empty($errors)) {
        ...
        // Admin-added employees get 'user' role by default
        $sql = "INSERT INTO employees (firstname, lastname, password, email, gender, role)
                VALUES ('$safe_first','$safe_last','$hashed_pw','$safe_email','$safe_gender','user')";
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .card { background: var(--card); border: 1px solid var(--border); border-radius: var(--r); padding: 2.4rem; }
    ...
    .rules strong {
      color: var(--accentH); display: block; margin-bottom: .3rem;
    ...
    .char-count { font-size: .72rem; color: var(--dim); font-weight: 400; text-transform: none; letter-spacing: 0; }
    ...
    .field input.is-error { border-color: var(--coral); box-shadow: 0 0 0 3px rgba(255,107,107,.1); }

    .field-error {
      display: flex; align-items: center; gap: .35rem;
      color: var(--coral); font-size: .78rem; margin-top: .4rem;
    }

    .strength-wrap { margin-top: .5rem; }
    .strength-bar { height: 3px; border-radius: 99px; background: var(--border2); overflow: hidden; margin-bottom: .3rem; }
    ...
    .btn-submit {
      ...
      margin-top: .5rem; transition: background .2s, transform .1s;
    }
...
<div class="wrap">
  ...
  <div class="card">
    <div class="card-head">
      <h1>Add Employee</h1>
      <p>Admin — create a new employee record</p>
    </div>
    ...
    <form method="post" action="create.php" novalidate>
      ...
      <div class="form-row">
        <div class="field">
          <label>First Name <span class="char-count" id="fn-count">0/50</span></label>
        ...
        <div class="field">
          <label>Last Name <span class="char-count" id="ln-count">0/50</span></label>
          <div class="input-wrap">
            <svg class="icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>
            </svg>
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          ...
          <input type="email" name="email" placeholder="employee@example.com" maxlength="150"
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          ...
          <input type="password" name="password" id="pw"
                 placeholder="Min 6 chars, 1 uppercase, 1 number" maxlength="72"
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          ...
          <input type="password" name="confirm_password" id="cpw"
                 placeholder="Re-enter password" maxlength="72"
