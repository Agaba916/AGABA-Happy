...
<head>
  ...
  <title>Register — EmployeeDB</title>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .login-link a:hover { color: var(--accentH); }
...
<div class="wrap">
  ...
  <div class="card">
    <div class="card-head">
      ...
      <p>Register to access the employee system</p>
    </div>
      ...
      <div class="field">
        ...
        <div class="input-wrap">
          ...
          <input type="password" name="confirm_password" id="cpw"
                 placeholder="Re-enter your password" maxlength="72"
